...
function draw() {
  ...
  if(gameState === play) {
    ...
    fill("white");
    textSize(40);
    text("GAME OVER !!",canvas.width/2-400,canvas.height/2-200);
    text("The asteroids destroyed your spaceship",canvas.width/2-400,canvas.height/2-120);
    text("Your score:"+score,canvas.width/2-400,canvas.height/2-50);

    fill("yellow");
    stroke("white")
    text("(Press 'R' to restart..... )",canvas.width/2-400,canvas.height/2+100);
